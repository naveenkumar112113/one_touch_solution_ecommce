...
const categories = [
    { id: 1, name: 'Mobile Cases', icon: <FaMobileAlt size={28} />, path: '/categories?key=mobile_cases', color: 'text-blue-500' },
    ...
    { id: 4, name: 'Mobile Acc.', icon: <FaHeadphonesAlt size={28} />, path: '/categories?key=mobile_accessories', color: 'text-pink-500' },
    { id: 5, name: 'Laptop Parts', icon: <FaLaptop size={28} />, path: '/categories?key=laptop_components', color: 'text-teal-500' },
    { id: 6, name: 'Mobile Parts', icon: <FaBatteryFull size={28} />, path: '/products/mobile', color: 'text-orange-500' },
    { id: 7, name: 'Tablet & Acc.', icon: <FaTabletAlt size={28} />, path: '/categories?key=tablet_accessories', color: 'text-purple-500' },
    { id: 8, name: 'Repair Tools', icon: <FaTools size={28} />, path: '/categories?key=repair_tools', color: 'text-red-500' },
];
